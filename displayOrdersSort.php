...
if (!empty($errMsg)) {
    ...
    $sort = $_GET['sort'];
		...
		$query = "select * from " .$sql_table . $str_query_attributes. " order by " .$sort." ASC";
		...
		if(!$result) {
			...
			echo "<table border=\"1\">";
			echo "<tr>\n"
            ."<th scope=\"col\"><a href=displayOrdersSort1.php?sort=order_id>Order ID</a></th>\n"
            ."<th scope=\"col\"><a href=displayOrdersSort1.php?sort=order_time>Time</a></th>\n"
            ."<th scope=\"col\"><a href=displayOrdersSort1.php?sort=order_status>Status</a></th>\n"
            ."<th scope=\"col\">Change Status</th>\n"
            ."<th scope=\"col\"><a href=displayOrdersSort1.php?sort=first_name>First Name</a></th>\n"
            ."<th scope=\"col\"><a href=displayOrdersSort1.php?sort=last_name>Last Name</a></th>\n"
            ."<th scope=\"col\"><a href=displayOrdersSort1.php?sort=product>Product</a></th>\n"
            ."<th scope=\"col\"><a href=displayOrdersSort1.php?sort=product_features>Features</a></th>\n"
            ."<th scope=\"col\"><a href=displayOrdersSort1.php?sort=product_quantity>Quanty</a></th>\n"
            ."<th scope=\"col\"><a href=displayOrdersSort1.php?sort=order_cost>Cost</a></th>\n"
